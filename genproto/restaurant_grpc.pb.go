...
const (
	RestaurantService_CreateRestaurant_FullMethodName  = "/protos.RestaurantService/CreateRestaurant"
	RestaurantService_GetByIdRestaurant_FullMethodName = "/protos.RestaurantService/GetByIdRestaurant"
	RestaurantService_GetAllRestaurants_FullMethodName = "/protos.RestaurantService/GetAllRestaurants"
	RestaurantService_UpdateRestaurant_FullMethodName  = "/protos.RestaurantService/UpdateRestaurant"
	RestaurantService_DeleteRestaurant_FullMethodName  = "/protos.RestaurantService/DeleteRestaurant"
)
...
func (c *restaurantServiceClient) GetByIdRestaurant(ctx context.Context, in *IdRequest, opts ...grpc.CallOption) (*RestaurantResponse, error) {
	...
	err := c.cc.Invoke(ctx, RestaurantService_GetByIdRestaurant_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _RestaurantService_GetByIdRestaurant_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RestaurantService_GetByIdRestaurant_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
