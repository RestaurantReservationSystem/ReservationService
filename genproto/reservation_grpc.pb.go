...
const (
	ReservationService_CreateReservation_FullMethodName  = "/protos.ReservationService/CreateReservation"
	ReservationService_UpdateReservation_FullMethodName  = "/protos.ReservationService/UpdateReservation"
	ReservationService_DeleteReservation_FullMethodName  = "/protos.ReservationService/DeleteReservation"
	ReservationService_GetByIdReservation_FullMethodName = "/protos.ReservationService/GetByIdReservation"
	ReservationService_GetAllReservation_FullMethodName  = "/protos.ReservationService/GetAllReservation"
)
...
func (c *reservationServiceClient) GetByIdReservation(ctx context.Context, in *IdRequest, opts ...grpc.CallOption) (*ReservationResponse, error) {
	...
	err := c.cc.Invoke(ctx, ReservationService_GetByIdReservation_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ReservationService_GetByIdReservation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReservationService_GetByIdReservation_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
